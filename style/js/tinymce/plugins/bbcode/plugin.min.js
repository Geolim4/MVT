! function() {
	tinymce.create("tinymce.plugins.BBCodePlugin", {
		...
		_punbb_html2bbcode: function(o) {
			...
			e(/<div class=\"codeStyle\">\s?<pre>(.*?)<\/pre>\s?<\/div>/gi, "[code]$1[/code]"), 
		...
		_punbb_bbcode2html: function(o) {
			...
			e(/\[size=(.*?)\](.*?)\[\/size\]/gi, "<span style=\"font-size:$1;\">$2</span>&nbsp;"), 
			e(/\[code\](.*?)\[\/code\]/gi, '<div class="codeStyle"><pre>$1</pre></div>&nbsp;'), 
			e(/\[quote.*?\](.*?)\[\/quote\]/gi, '<span class="quoteStyle">$1</span>&nbsp;'), o
		}
